...
2. **Excavate the problem behind the ask** — goal-divergence check, evidence gate ("observed, or remembered?"), breadth check; runs after context load, before any clarifying question
...
digraph brainstorming {
    ...
    "Excavate problem behind the ask\n(divergence check · evidence gate · breadth)" [shape=box];
    ...
    "Explore project context" -> "Excavate problem behind the ask\n(divergence check · evidence gate · breadth)";
    "Excavate problem behind the ask\n(divergence check · evidence gate · breadth)" -> "Visual questions ahead?";
