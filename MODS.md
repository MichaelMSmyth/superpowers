...
| 2026-07-15 | skills/brainstorming/SKILL.md | intake round (b): problem-excavation front-load (goal-divergence check after context load, XY escape, evidence gate, MECE breadth), question mechanics (defaults, fork-naming, escape, stopping rule), Load-bearing-choices assay table in specs (spec §2.11+§2.13; finding 2026-07-15-design-question-research) |
| 2026-07-15 | skills/systematic-debugging/SKILL.md | intake round (e): pre-retry gate — before any re-run/restart/relaxed-parameter: enumerate failed-run artifacts, state the retry's hypothesis, name what it would destroy; worked example = 2026-07-14 eval-timeout artifact (spec §2.13) |
